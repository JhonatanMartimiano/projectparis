        ...
        <div class="side-app">
            <div class="page-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Atrasados</li>
                </ol>
            </div>
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card m-b-20">
                        <div class="card-header">
                            <h3 class="card-title">Clientes Atrasados 24H+</h3>
                        </div>
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center justify-content-center">
                                <h4>Último Contato</h4>
                                <form class="form-inline ajax_off mb-1" action="<?= url('/admin/dash/late'); ?>"
                                      method="post">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered border-top mb-0">
                                    ...
                                    <tbody>
                                    <?php if ($post24hourArr): ?>
                                        <?php foreach ($post24hourArr as $negPost): ?>
                                            <tr class="bg-danger text-white">
                                                <td><?= $negPost->infoClient()->name; ?></td>
